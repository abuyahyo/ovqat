...
ВАЗИФА
Шу масаллиқлардан тайёрлаш мумкин бўлган 4–10 та ҲАҚИҚИЙ, маъқул таомни таклиф қил. Сонга эмас, СИФАТГА диққат қил — масаллиқлар чекланган бўлса 4–6 та сифатли таклиф бер, 10 тагача сунъий равишда чўзма.

ҲАҚИҚИЙ ТАОМЛАР ҚОИДАСИ — МУҲИМ
- Фақат ҲАҚИҚАТАН мавжуд, аниқ номли таомларни таклиф қил: миллий таомлар (Ош, Лағмон, Манти, Шўрва, Мастава, Қовурдоқ, Димлама, Жиз-биз, Угра, Шавля, Сомса, Чучвара, Кабоб, Хонум, Норин, Тандир гўшт, Чалпак, Қуймоқ, Кулча, Ҳалва ва ҳ.к.) ёки умумжаҳон билинадиган таомлар (омлет, спагетти болоньезе, цезарь салат, оливье, борщ, винегрет ва ҳ.к.).
- Сохта/ўйлаб топилган номлар ҚИЛМА. Қуйидагилар НОТЎҒРИ:
  • "Қаймоқли тухум" — оддий таркиб ҳисоби, реал таом эмас (тўғриси: "Омлет" ёки "Йирилган тухум")
  • "Помидорли пиёз" — реал таом эмас (тўғриси: "Помидор салат" ёки "Аччиқ-чучук")
  • "Гўштли картошка" — мавҳум (тўғриси: "Картошкали қовурдоқ" ёки "Картошка ва гўштли димлама")
- Қоида: агар таом номини Google'да қидирсангиз 100+ натижа топилмаса — нотўғри ном. Реал, шу номли таом мавжудлигига ишонч ҳосил қил.
- Иккинчи ҳалол қоида: "Х-ли Y" қолипидаги номлар фақат шундай номли РЕАЛ таом бўлсагина ишлатилади ("Қаймоқли спагетти" — реал; "Қаймоқли тухум" — реал эмас).

Фақат таом ҒОЯСИНИ бер — батафсил рецепт, масаллиқ миқдори ёки тайёрлаш қадамлари ЁЗМА (улар кейинроқ алоҳида сўралади). Бир хил турни такрорлама. Турли йўналишларни қамраб ол: асосий таом, шўрва, салат, нонушта, ширинлик — масаллиқларга мос ҳолда.
